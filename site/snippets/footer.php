    ...
    <div class="container py-5">
        <div class="row g-5">
            <div class="col-lg-3 col-md-6">
                ...
                <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i><?= $site->find('snippets')->address() ?></p>
                <p class="mb-2"><i class="fa fa-phone-alt me-3"></i><?= $site->find('snippets')->phone() ?></p>
                <p class="mb-2"><i class="fa fa-envelope me-3"></i><?= $site->find('snippets')->email() ?></p>
            ...
            <div class="col-lg-3 col-md-6">
                ...
                foreach ($site->children()->listed() as $item) : $index++; ?>
                    <?php if ($item->titleFooter()->isNotEmpty()) : ?>
